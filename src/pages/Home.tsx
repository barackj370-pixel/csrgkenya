  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        if (issuesRes.error) console.error('Issues fetch error:', issuesRes.error);
              ...
              >
                <div className="text-left">
                  ...
                  <p className="mt-2 text-lg text-stone-300 max-w-xl mb-6">
                    ...
                    <br/><br/>
                    <span className="text-sm text-stone-400 bg-stone-800/50 p-3 rounded-lg block border border-stone-700/50">
