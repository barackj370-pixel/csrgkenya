      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-stone-200 mb-12">
          ...
          <p className="text-stone-600 leading-relaxed">
            Our platform facilitates Ward Citizen Assemblies—structured, quarterly gatherings where residents, clerks, and elected leaders convene to discuss pressing issues, propose actionable solutions, and track the implementation of ward development funds and projects.
          </p>
        </div>
        ...
        <div className="bg-stone-900 text-white rounded-3xl p-8 md:p-12 text-center">
          ...
          <p className="text-stone-300 max-w-2xl mx-auto mb-8">
            Whether you are a community clerk, a local leader, or a concerned citizen, your participation is vital. Find your ward and join the next assembly.
          </p>
